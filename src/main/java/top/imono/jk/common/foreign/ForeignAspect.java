package top.imono.jk.common.foreign;
...
public class ForeignAspect implements InitializingBean {
    private static final String FOREIGN_SCAN = "classpath*:top/imono/jk/pojo/po/**/*.class";
    @Autowired
    private ApplicationContext ctx;
    @Autowired
    private ResourceLoader resourceLoader;

//    @Around("execution(* top.imono.jk.service..*.remove*(..))")
//    @Around("execution(* com.baomidou.mybatisplus.extension.service..*.remove*(..))")
    @Around("execution(* top.imono.jk.service..*.remove*(..))")
    ...
    @Around("execution(* top.imono.jk.service..*.save*(..)) || execution(* top.imono.jk.service..*.update*(..)) ")
